...
@WebMvcTest(CalOperation.class)

public class CalOperationIntegrationTest
{
    @Autowired
    private MockMvc mockMvc;

    @Test
    public void CalOperationIntegrationTestAdd() throws Exception
    {
        long a = (long) 5.0;
        long b = (long) 4.0;
    ...
    @Test
    public void CalOperationIntegrationTestSub() throws Exception
    {
        long a = (long) 12.0;
        long b = (long) 5.0;
    ...
    @Test
    public void CalOperationIntegrationTestMul() throws Exception
    {
        long a = (long) 15.0;
        long b = (long) 9.0;
    ...
    @Test
    public void CalOperationIntegrationTestDiv() throws Exception
    {
        long a = (long) 9.0;
        long b = (long) 3.0;
